...
int main(int argc, char **argv) {
    ...
    struct blockArray* (*create_main_array)() = (struct blockArray* (*)())dlsym(handle, "create_main_array");
    
    int (*createBlock)() = (int (*)())dlsym(handle, "create_block");
    void (*deleteBlock)() = (void (*)())dlsym(handle, "delete_block");
    void (*deleteOperation)() = (void (*)())dlsym(handle, "delete_operation");
    ...
    while(i<argc){
        ...
        if(strcmp(argv[i], "create_table") == 0){
            ...
            main_tab = (*create_main_array)(atoi(argv[i+1]));
            i += 2;
